...
$(document).ready(function() {
    ...
    loginSubmit.click(function() {
        ...
        var regEmailPatten = /^[a-zA-Z_\-0-9]+@[a-z]+.[a-z]+$/
        ...
        if(loginPw.val().length < 8) {
            alert('비밀번호를 입력하지 않았거나 8글자 이하 입니다.')
            return false
        }
    })
...
$(document).ready(function(){
    ...
    loginSubmit.click(function(){
        ...
        if(loginPw.val().length < 8){
            ...
            return false;
>>>>>>> 3f21cad11e7920799d00672b0f6a2d4856334023
        }
    });
...
<<<<<<< HEAD
    ...
    //setTimeout 함수를 어떠한 기능의 시간을 지연시킬 때 사용하는 내장 함수
        setTimeout(function() {
        $('#valueError').text('')
        }, 2000)
    }
